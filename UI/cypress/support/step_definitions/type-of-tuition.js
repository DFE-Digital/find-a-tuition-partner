...
Given("the 'Type of tuition' page is displayed", () => {
  cy.visit(
    "which-tuition-types?From=SearchResults&Postcode=wc1h8hl&Subjects=KeyStage3-Maths&Subjects=KeyStage3-Modern%20foreign%20languages&Subjects=KeyStage4-Maths&Subjects=KeyStage4-Modern%20foreign%20languages&KeyStages=KeyStage3&KeyStages=KeyStage4"
  );
});
...
Then("they will be taken to the 'Type of tuition' page", () => {
  cy.visit(
    "/which-tuition-types?Postcode=SK1%201EB&Subjects=KeyStage1-English&Subjects=KeyStage1-Maths&Subjects=KeyStage2-English&Subjects=KeyStage2-Maths&TuitionType=Any&KeyStages=KeyStage1&KeyStages=KeyStage2"
  );
});
