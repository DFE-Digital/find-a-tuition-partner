...
Then("they will see the legislation link", () => {
  cy.get('[data-testid="legislation-link"]').should(
    "have.attr",
    "href",
...
Then("they will see cannot access part header", () => {
  cy.get('[data-testid="access-parts-header"]').should(
    "contain.text",
...
Then("they will see reporting accesibility problems header", () => {
  cy.get('[data-testid="accessibility-reporting-header"]').should(
    "contain.text",
...
Then("they will see enforcement procedure header", () => {
  cy.get('[data-testid="accessibility-enforcement-header"]').should(
    "contain.text",
...
Then("they will see link to equality advisory service", () => {
  cy.get('[data-testid="contact-quality-link"]').should(
    "have.attr",
    "href",
...
Then("they will see header improve accesibility", () => {
  cy.get('[data-testid="improve-accessibility-header"]').should(
    "contain.text",
...
Then("they will see header accessibility technical header", () => {
  cy.get('[data-testid="accessibility-technical-information-header"]').should(
    "contain.text",
...
Then("they will see header Compliance status", () => {
  cy.get('[data-testid="compliance-status-header"]').should(
    "contain.text",
    "Compliance status"
  );
});
...
Then("they will see header how we tested website", () => {
  cy.get('[data-testid="tested-website-header"]').should(
    "contain.text",
